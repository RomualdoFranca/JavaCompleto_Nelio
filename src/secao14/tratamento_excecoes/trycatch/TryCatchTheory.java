...
public class TryCatchTheory {
	...
	public static void main(String[] args) {
		...
		//um vetor de string que vai receber um nextLine().split(" ") baseado num espaço em branco
		//ler varios dados na mesma linha separado por espaço em branco e cada um desses dados vai ser um elemento do vetor
...
//		System.out.println(vect[position]);
		...
		//por exemplo:ao inserir 3 nomes no vetor, ele tera 2 como numero maximo da variavel position
		...
		try {
			...
			//caso uma posição que não exista for inserida, a mensagem do bloco catch sera impressa
